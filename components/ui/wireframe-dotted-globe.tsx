...
export function RotatingEarth({ width = 800, height = 600, className = "" }: RotatingEarthProps) {
    ...
    useEffect(() => {
        ...
        const render = () => {
            ...
            // Removed solid black so it blends with the hero
            // context.beginPath()
            ...
            if (landFeatures) {
                ...
                allDots.forEach((dot) => {
                    ...
                    // Check if dot is in front of the globe
                    // We can approximate this by seeing if drawing it fits in the radius,
                    // but D3 geoOrthographic clips behind the sphere.
                    if (
                        projected &&
                        projected[0] >= 0 &&
